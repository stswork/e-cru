...
create table data_collection_form4 (
  ...
  constraint ck_data_collection_form4_lesion_location check (lesion_location in (0,1,2,3,4,5)),
  ...
  constraint ck_data_collection_form4_ecg_result check (ecg_result in (0,1,2,3,4,5,6,7,8)),
  constraint ck_data_collection_form4_echo_result check (echo_result in (0,1,2,3,4,5,6,7,8)),
  constraint ck_data_collection_form4_discharge_place check (discharge_place in (0,1,2,3,4)),
...
create table data_collection_form5 (
  ...
  clopidogrel_dosage        varchar(255),
  aspirin_plus_clopidogrel  integer,
  aspirin_plus_clopidogrel_dosage1 varchar(255),
  aspirin_plus_clopidogrel_dosage2 varchar(255),
  dipyridamole              integer,
  dipyridamole_dosage       varchar(255),
  aspirin_plus_dipyridamole integer,
