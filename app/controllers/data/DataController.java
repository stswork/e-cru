...
public class DataController extends Controller {
    ...
    public static Result handleSaveForm4() {
        ...
        YesNo anterior = YesNo.valueOf(map.containsKey("anterior") ? StringUtils.EMPTY : map.get("anterior")[0]);
        YesNo right = YesNo.valueOf(map.containsKey("right") ? StringUtils.EMPTY : map.get("right")[0]);
        YesNo left = YesNo.valueOf(map.containsKey("left") ? StringUtils.EMPTY : map.get("left")[0]);
        YesNo bilateral = YesNo.valueOf(map.containsKey("bilateral") ? StringUtils.EMPTY : map.get("bilateral")[0]);
        YesNo posterior = YesNo.valueOf(map.containsKey("posterior") ? StringUtils.EMPTY : map.get("posterior")[0]);
        YesNo anterioposterior = YesNo.valueOf(map.containsKey("anterioposterior") ? StringUtils.EMPTY : map.get("anterioposterior")[0]);
        ...
        YesNo lvd = YesNo.valueOf(map.containsKey("lvd") ? StringUtils.EMPTY : map.get("lvd")[0]);
        YesNo svd = YesNo.valueOf(map.containsKey("svd") ? StringUtils.EMPTY : map.get("svd")[0]);
        YesNo cardioembolism = YesNo.valueOf(map.containsKey("cardioembolism") ? StringUtils.EMPTY : map.get("cardioembolism")[0]);
        YesNo combined = YesNo.valueOf(map.containsKey("combined") ? StringUtils.EMPTY : map.get("combined")[0]);
        YesNo strokeOfDeterminedEtiology = YesNo.valueOf(map.containsKey("strokeOfDeterminedEtiology") ? StringUtils.EMPTY : map.get("strokeOfDeterminedEtiology")[0]);
        YesNo negativeEvaluation = YesNo.valueOf(map.containsKey("negativeEvaluation") ? StringUtils.EMPTY : map.get("negativeEvaluation")[0]);
        ...
        YesNo ecgLvf = YesNo.valueOf(map.containsKey("ecgLvf") ? StringUtils.EMPTY : map.get("ecgLvf")[0]);
        YesNo ecgAf = YesNo.valueOf(map.containsKey("ecgAf") ? StringUtils.EMPTY : map.get("ecgAf")[0]);
        YesNo ecgVentricularEctopics = YesNo.valueOf(map.containsKey("ecgVentricularEctopics") ? StringUtils.EMPTY : map.get("ecgVentricularEctopics")[0]);
        YesNo ecgArtialEctopics = YesNo.valueOf(map.containsKey("ecgArtialEctopics") ? StringUtils.EMPTY : map.get("ecgArtialEctopics")[0]);
        YesNo ecgNoneOfAbove = YesNo.valueOf(map.containsKey("ecgNoneOfAbove") ? StringUtils.EMPTY : map.get("ecgNoneOfAbove")[0]);
        YesNo ecgDontKnow = YesNo.valueOf(map.containsKey("ecgDontKnow") ? StringUtils.EMPTY : map.get("ecgDontKnow")[0]);
        YesNo echoNormal = YesNo.valueOf(map.containsKey("echoNormal") ? StringUtils.EMPTY : map.get("echoNormal")[0]);
        YesNo echoLvh = YesNo.valueOf(map.containsKey("echoLvh") ? StringUtils.EMPTY : map.get("echoLvh")[0]);
        YesNo echoPfo = YesNo.valueOf(map.containsKey("echoPfo") ? StringUtils.EMPTY : map.get("echoPfo")[0]);
        YesNo echoThrombus = YesNo.valueOf(map.containsKey("echoThrombus") ? StringUtils.EMPTY : map.get("echoThrombus")[0]);
        YesNo echoNoneOfAbove = YesNo.valueOf(map.containsKey("echoNoneOfAbove") ? StringUtils.EMPTY : map.get("echoNoneOfAbove")[0]);
        YesNo echoDontKnow = YesNo.valueOf(map.containsKey("echoDontKnow") ? StringUtils.EMPTY : map.get("echoDontKnow")[0]);
        ...
        YesNo home = YesNo.valueOf(map.containsKey("home") ? StringUtils.EMPTY : map.get("home")[0]);
        YesNo nursingHome = YesNo.valueOf(map.containsKey("nursingHome") ? StringUtils.EMPTY : map.get("nursingHome")[0]);
        YesNo rehabilitation = YesNo.valueOf(map.containsKey("rehabilitation") ? StringUtils.EMPTY : map.get("rehabilitation")[0]);
        YesNo rip = YesNo.valueOf(map.containsKey("rip") ? StringUtils.EMPTY : map.get("rip")[0]);
        YesNo localDgh = YesNo.valueOf(map.containsKey("localDgh") ? StringUtils.EMPTY : map.get("localDgh")[0]);
