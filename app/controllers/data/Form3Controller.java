...
public class Form3Controller extends Controller {
    ...
    public static Result handleSaveForm3() {
        ...
        YesNo antihypertensive = YesNo.valueOf(StringUtils.isEmpty(map.get("antihypertensive")[0]) ? StringUtils.EMPTY : map.get("antihypertensive")[0].toUpperCase());
        ...
        YesNo medicineNoneOfTheAbove = YesNo.valueOf(StringUtils.isEmpty(map.get("medicineNoneOfTheAbove")[0]) ? StringUtils.EMPTY : map.get("medicineNoneOfTheAbove")[0].toUpperCase());

        YesNo glucoseBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("glucoseBloodTest")[0]) ? StringUtils.EMPTY : map.get("glucoseBloodTest")[0].toUpperCase());
        ...
        YesNo totalCholesterolBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("totalCholesterolBloodTest")[0]) ? StringUtils.EMPTY : map.get("totalCholesterolBloodTest")[0].toUpperCase());
        ...
        YesNo hdlCholesterolBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("hdlCholesterolBloodTest")[0]) ? StringUtils.EMPTY : map.get("hdlCholesterolBloodTest")[0].toUpperCase());
        ...
        YesNo ldlCholesterolBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("ldlCholesterolBloodTest")[0]) ? StringUtils.EMPTY : map.get("ldlCholesterolBloodTest")[0].toUpperCase());
        ...
        YesNo triglycerideBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("triglycerideBloodTest")[0]) ? StringUtils.EMPTY : map.get("triglycerideBloodTest")[0].toUpperCase());
        ...
        YesNo esrBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("esrBloodTest")[0]) ? StringUtils.EMPTY : map.get("esrBloodTest")[0].toUpperCase());
        ...
        YesNo crpBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("crpBloodTest")[0]) ? StringUtils.EMPTY : map.get("crpBloodTest")[0].toUpperCase());
        ...
        YesNo troponimBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("troponimBloodTest")[0]) ? StringUtils.EMPTY : map.get("troponimBloodTest")[0].toUpperCase());
        ...
        YesNo proteinCBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("proteinCBloodTest")[0]) ? StringUtils.EMPTY : map.get("proteinCBloodTest")[0].toUpperCase());
        ...
        YesNo proteinSBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("proteinSBloodTest")[0]) ? StringUtils.EMPTY : map.get("proteinSBloodTest")[0].toUpperCase());
        ...
        YesNo fibrinogenBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("fibrinogenBloodTest")[0]) ? StringUtils.EMPTY : map.get("fibrinogenBloodTest")[0].toUpperCase());
        ...
        YesNo antithrombin11BloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("antithrombin11BloodTest")[0]) ? StringUtils.EMPTY : map.get("antithrombin11BloodTest")[0].toUpperCase());
        ...
        YesNo factorVBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("factorVBloodTest")[0]) ? StringUtils.EMPTY : map.get("factorVBloodTest")[0].toUpperCase());
        ...
        YesNo homocysteineBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("homocysteineBloodTest")[0]) ? StringUtils.EMPTY : map.get("homocysteineBloodTest")[0].toUpperCase());
        ...
        YesNo prothrombinBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("prothrombinBloodTest")[0]) ? StringUtils.EMPTY : map.get("prothrombinBloodTest")[0].toUpperCase());
        ...
        YesNo antiphospholipidBloodTest = YesNo.valueOf(StringUtils.isEmpty(map.get("antiphospholipidBloodTest")[0]) ? StringUtils.EMPTY : map.get("antiphospholipidBloodTest")[0].toUpperCase());
        ...
        YesNo carotidEndarterectomyDone = YesNo.valueOf(StringUtils.isEmpty(map.get("carotidEndarterectomyDone")[0]) ? StringUtils.EMPTY : map.get("carotidEndarterectomyDone")[0].toUpperCase());
        YesNo thrombolysedDone = YesNo.valueOf(StringUtils.isEmpty(map.get("thrombolysedDone")[0]) ? StringUtils.EMPTY : map.get("thrombolysedDone")[0].toUpperCase());
        YesNo ctaDone = YesNo.valueOf(StringUtils.isEmpty(map.get("ctaDone")[0]) ? StringUtils.EMPTY : map.get("ctaDone")[0].toUpperCase());
        YesNo mraDone = YesNo.valueOf(StringUtils.isEmpty(map.get("mraDone")[0]) ? StringUtils.EMPTY : map.get("mraDone")[0].toUpperCase());
        YesNo angiogramDone = YesNo.valueOf(StringUtils.isEmpty(map.get("angiogramDone")[0]) ? StringUtils.EMPTY : map.get("angiogramDone")[0].toUpperCase());
