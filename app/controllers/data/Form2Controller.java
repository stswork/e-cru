...
public class Form2Controller extends Controller {
    ...
    public static Result handleSaveForm1() {
        ...
        Integer ischaemicStrokeYear = Integer.valueOf(map.get("ischaemicStrokeYear").length <= 0 ? StringUtils.EMPTY : map.get("ischaemicStrokeYear")[0]);
        Integer hoemorrhagicStrokeYear = Integer.valueOf(map.get("hoemorrhagicStrokeYear").length <= 0 ? StringUtils.EMPTY : map.get("hoemorrhagicStrokeYear")[0]);
        Integer tiaYear = Integer.valueOf(map.get("tiaYear").length <= 0 ? StringUtils.EMPTY : map.get("tiaYear")[0]);
        ...
        YesNo currentSmoker = YesNo.valueOf(map.get("currentSmoker").length <= 0 ? StringUtils.EMPTY : map.get("currentSmoker")[0].toUpperCase());
        Integer cigarettePerDay = Integer.valueOf(map.get("cigarettePerDay").length <= 0 ? StringUtils.EMPTY : map.get("cigarettePerDay")[0]);
        YesNo exSmoker = YesNo.valueOf(map.get("exSmoker").length <= 0 ? StringUtils.EMPTY : map.get("exSmoker")[0].toUpperCase());
        YesNo never = YesNo.valueOf(map.get("never").length <= 0 ? StringUtils.EMPTY : map.get("never")[0].toUpperCase());
